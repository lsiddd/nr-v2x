...
public:
    ...
    qreal getNextPacketTime();
    qreal getNextPacketTime(qreal currentTime);
    ...
    void setShowBatteryCapacity(bool show);
    ...
    void showNode(uint32_t nodeId, bool show);
...
private:
    ...
    qreal packetForwardScan(double currentTime);
